...
/*
This is one way but it will give TLE for n = 10^5

Better approach would be to take c = n- a - b,  and substitute in pythagorean triplet
equation. Thus there will just be 2 variables, a and b to solve for.
