...
//STL debug by print
template<typename T1, typename T2>
inline ostream& operator << (ostream& os, const pair<T1, T2>& t){ return os << endl << t.first << " " << t.second<<endl; }
template<typename T1, typename T2, typename T3>
...
template<typename T>inline ostream &operator<<(ostream &os,const vector<T>& v){for(T i:v){os<<i;}return os;}
